      ...
      <div class="container">
          ...
          <div class="blog-info">
              ...
              <div class="upload-file">
                  ...
                  <button @click="openPreview" class="preview" :class="{'button-inactive' : !this.$store.state.blogPhotoFileURL }">Preview the Photo</button>
...
export default {
    ...
    async mounted() {
      ...
      this.$store.commit('setBlog', this.currentBlog[0])
    },
    methods: {
        fileChange() {
             ...
             if (this.blogTitle.length !==0 && this.blogHTML.length !== 0) {
                 if (this.file) {
                     ...
                     docRef.put(this.file).on("state_changed", (snapshot) => {
                         ...
                         await this.$store.state.dispatch("updatePost", this.routeID);
                         this.loading = false;
