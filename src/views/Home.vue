<template>
  <div class="home">
    ...
    <div class="blog-card-wrap">
      <div class="container">
        <h3>View More Blogs from other photo-lovers</h3>
        <div class="blog-cards">
          <BlogCards :post="post" v-for="(post, index) in blogPostCards" :key="index" />
        </div>
      </div>
    </div>
  ...
  data() {
    return {
      welcomeScreen: {
        title: "Welcome!",
        blogPost:
          "Weekly blog photos with all things in it. Register today to never miss a post!",
        welcomeScreen: true,
        photo: "shooting",
      },
